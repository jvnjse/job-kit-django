    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_verified', models.BooleanField(default=False)),
                ('company_user_id', models.ForeignKey(limit_choices_to={'user_type': 'company'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('departments', models.ManyToManyField(to='company.department')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_department', models.ManyToManyField(to='company.department')),
            ],
        ),
        migrations.CreateModel(
            name='JobDetail',
